"""Script for training M-DyNeMo on the Wakeman-Henson dataset."""
...
tmp_dir = f"tmp/wh_mdynemo/run{id:02d}"
data_dir = "/well/woolrich/projects/wakeman_henson/spring23/src"
data = load_data(data_dir, tmp_dir, n_jobs=6)
run_pipeline(
    config,
    output_dir=f"results/wh_mdynemo/run{id:02d}",
    data=data,
)
